describe('Jest v30 Updated Matchers Demo', () => {
  describe('Mock function matchers updated for Jest v30', () => {
  ...
  describe('Return value matchers updated for Jest v30', () => {
  ...
  describe('Error matchers updated for Jest v30', () => {
